...
const features = [
    ...
    },
    {
        ...
        description:
            "High-quality, embedded data keeps users inside your product rather than defaulting to generic copilots.",
    },
    {
        icon: Award,
        title: "Durable Differentiation",
        description:
            "Access to proprietary and premium data creates defensible separation from horizontal AI tools.",
    },
]
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="max-w-5xl mx-auto mb-16 text-center">
                    <h2 className="mb-4 text-3xl md:text-5xl font-black">
                        Make your agents more valuable, trusted and
                        differentiated
                    </h2>
                </div>
