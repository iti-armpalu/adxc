  ...
  return (
    <Section size="md" className="relative">
      <Container size="md">
        ...
        <div className="absolute mt-2 left-4 top-1/4 -translate-y-1/2 max-w-[200px] hidden xl:block">
        ...
        <div className="absolute mt-8 left-4 top-2/3 -translate-y-1/2 max-w-[200px] hidden xl:block">
          <div className="flex flex-col">
            <div className="bg-card/80 backdrop-blur-xl border border-adxc rounded-xl px-4 py-3 shadow-md">
              <p className="text-sm text-muted-foreground leading-relaxed">
